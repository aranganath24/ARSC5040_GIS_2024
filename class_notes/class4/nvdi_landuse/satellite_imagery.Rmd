...
The data were initially retrieved from R's MODIStsp package (mentioned above), and can also be retrieved from this page on [MODIS Vegetation Products](https://modis.gsfc.nasa.gov/data/dataprod/mod13.php). Note that the dataset corresponds to the "Vegetation Indices 16-Day L3 Global 250m" dataset, clipped to the extent of Colorado, for the date July 3rd, 2020 (since we're interested in viewing the spatial distribution of live vegetation in Colorado, it makes sense to pick a day during peak-summer). 
...
The data we're using was initially extracted using the *MODIStsp* package, but can also be downloaded from the MODIS page for land cover products, at this [link](https://lpdaac.usgs.gov/products/mcd12q1v006/). The data corresponds to the year 2019, 
