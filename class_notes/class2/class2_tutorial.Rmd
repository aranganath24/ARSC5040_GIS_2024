...
Let's reproject the fire station data into EPSG:2231 (the projection appropriate for Boulder) and assign the reprojected data to an object named ```boulder_fire_stations_projected```:
