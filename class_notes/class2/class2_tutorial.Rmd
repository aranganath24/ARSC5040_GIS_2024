...
Please load the following libraries (and install the packages that you have not yet installed using the ```install.packages() function). 
...
You'll notice that some of the locations fall outside of the area delimited by the Boulder county polygon; this could be due to error of various kinds. Instead of diagnosing it, let's just say you want to clip out the points outside of Boulder. 
